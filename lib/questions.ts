...
export const questionBank: Question[] = [
  ...
  { id: 'GEN-006', standard: 'MA.5.GR.3.1', type: 'multiple-select', text: 'If you start at the origin (0,0) and move right 5, which points lie on that vertical line?', diagram: { type: 'svg', content: drawCoordinatePlane([{x: 5, y: 0}, {x: 5, y: 5}, {x: 5, y: 8}, {x: 2, y: 5}]) }, options: ['(5,0)', '(5,5)', '(5,8)', '(2,5)'], correctAnswers: ['(5,0)', '(5,5)', '(5,8)'], explanation: 'x-coordinate must be 5.' },
  { id: 'GEN-007', standard: 'MA.5.DP.1.1', type: 'free-response', text: 'Find the total number of students represented in the chart.', diagram: { type: 'svg', content: drawBarChart([{label: 'Dogs', value: 12}, {label: 'Cats', value: 8}, {label: 'Birds', value: 5}], 15) }, correctAnswer: '25', explanation: '12 + 8 + 5 = 25.' },
