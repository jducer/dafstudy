  ...
  if (!testStarted && !generating) {
    return (
      <div style={{ maxWidth: '600px', margin: '80px auto', padding: '0 24px' }}>
        <div className="glass-card animate-fadeIn" style={{ padding: '40px', textAlign: 'center' }}>
          <div style={{ fontSize: '3.5rem', marginBottom: '20px' }}>🎯</div>
          <h1 style={{ fontWeight: 900, fontSize: '1.8rem', marginBottom: '12px' }}>Choose Your Mode</h1>
          <p style={{ color: 'var(--text-secondary)', marginBottom: '32px' }}>
            Dafne, how would you like to practice today?
          </p>
          
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <button className="btn-primary" onClick={startStaticTest} style={{ padding: '18px' }}>
              📚 Classic Practice
              <div style={{ fontSize: '0.75rem', fontWeight: 500, opacity: 0.8 }}>Hand-crafted questions from the bank</div>
            </button>
            <button className="btn-secondary" onClick={startDynamicTest} style={{ padding: '18px', border: '2px solid #9b5de5', color: '#9b5de5' }}>
              ✨ AI Dynamic Challenge
              <div style={{ fontSize: '0.75rem', fontWeight: 500, opacity: 0.8 }}>10 brand-new questions generated by AI</div>
            </button>
          </div>
